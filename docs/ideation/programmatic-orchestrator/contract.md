...
2. **Retry caps are reactive.** The doom-loop hook fires after 3 *identical* failures. A programmatic orchestrator caps retries proactively as a loop condition *before* they happen.
